document.addEventListener('DOMContentLoaded', () => {
	...
	// make the tetromino move down every second, only after pressing the start button
	// timerId = setInterval(moveDown, 1000); /* this makes the game start when page is loaded */
	...
	// move left, right and rotate, unless is at the edge or there is a blockage
	...
	const upNextTetrominoes = [
		...
		[0, displayWidth + 1, displayWidth * 2 + 1, 1], // jTetromino
	];
